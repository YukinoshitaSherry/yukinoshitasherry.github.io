...
- <a href="https://www.bilibili.com/video/BV1Zk9FBwELs?vd_source=fa4dcf78649ce6604c2727b4c64e76dc"> b站【最近爆火的 Harness Engineering 到底是啥？一期讲透！】</a>
...
- 参考 <a href="https://www.bilibili.com/video/BV1Zk9FBwELs?vd_source=fa4dcf78649ce6604c2727b4c64e76dc"> b站【最近爆火的 Harness Engineering 到底是啥？一期讲透！】</a>
...
1. **理解**：对齐用户目标与约束（或理解为对输入做理解与任务拆解）。
2. **判断 / 拆解**：判断信息是否充分、任务如何分解；若此步失败，通常应回到上一步重新理解或补全信息。
3. **生成输出**：按计划调用工具并产生中间或最终产物。
4. **检查输出**：对照验收标准与环境事实；若未通过，通常回到生成步骤修正，而非直接宣告完成。
...
1.经验是可以积累、在复用中形成复利的。曾经擅长Prompt Engineering的人，在Context Engineering到来后能够最快上手，同理迁移到Harness Engineering。
