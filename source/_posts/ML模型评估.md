...
| Fβ-Score   | Fβ-Score  | $F_\beta = (1 + \beta^2) \times \frac{Precision \times Recall}{\beta^2 \times Precision + Recall}$ |
| F1-Score   | F1-Score  | $F_1 = \frac{2 \times Precision \times Recall}{Precision + Recall}$ |
