...
- Rebuttal 的真正听众是 **AC / Editor**，而非某位审稿人；形式上是回复审稿意见，实质上是向 AC 呈现一份清晰、可信的材料。
...
动笔前先给意见**定级**，避免十条意见平均用力、分散篇幅。

| 类型 | 含义 | 示例 |
| :--- | :--- | :--- |
| **致命伤** | 不解决好则论文难以成立 | 创新性何在；核心假设是否成立；理论是否有硬伤 |
| **硬伤** | 重大缺陷，影响完整性与可信度 | 缺少关键对比；消融不全；模块动机不清；**核心概念、符号或流程表述不清**（易被误判为方法本身有问题） |
| **皮外伤** | 单个不致命，多则损害专业印象 | 笔误、图表格式、次要符号笔误、引用错误、附录细节 |

**约 80% 的篇幅与精力**应放在致命伤与硬伤上，回复需逻辑严密、证据充分。纯格式、笔误类皮外伤可在 rebuttal 开头或结尾**集中声明**一次；但若审稿人质疑的是**关键概念、符号或方法流程**不清楚，须单独展开说明改法，不宜并入笼统的“终稿修正”承诺。例如：

> 感谢各位审稿人细致的阅读与建议。关于笔误、图表格式、表述清晰度及引用规范等具体问题，均已记录，并承诺在终稿中逐一修正。

这样既体现态度，又把 AC 的注意力留在核心矛盾上。Rebuttal 也是在展示：作者分得清什么才是真正重要的问题。
...
> 您说的这个问题很严重，但我们觉得里面可能存在误解。能否说得更具体一些？非常感谢！这个问题很重要，非常期待您的进一步回复。
>
...
**显式区分**（当判断对方把主次搞反时）：
> 根据您的意见，我们感觉您可能认为 A 是主要问题，但 A 并不是主要问题：【1–2 句说明】。您提出的 B 倒是很有意思、很有启发，我们目前的工作确实在这方面有欠缺；但目前尚无工作能完全解决，我们的工作将这一问题向前推进了一步，要彻底解决可能需要另起一项研究。您的意见非常有见地，感谢！
