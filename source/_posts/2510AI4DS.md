...
- <a href="https://arxiv.org/abs/2510.23045"> A Survey of AI Scientists </a>
...
- **领域知识注入**【2025年出的几个DS Agent这块的trick已经玩出花了】：
  - 集成统计和数据科学最佳实践
  - 使用检索增强生成（RAG）从知识库中**检索**相关信息【如何抽取？如何匹配？如何rerank? RAG很简单，怎么选知识库的材料、以什么形式建库、怎么召回知识确保增强有效不简单。】
  - 结合领域特定术语库确保用词准确
